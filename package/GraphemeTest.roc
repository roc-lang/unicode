...
expect {
	exp = [[127462, 776], [127462]]
	got = [127462, 776, 127462]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[127462, 776], [44032]]
	got = [127462, 776, 44032]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[127462, 776], [44033]]
	got = [127462, 776, 44033]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[44032, 776], [127462]]
	got = [44032, 776, 127462]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[44033, 776], [127462]]
	got = [44033, 776, 127462]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[127462, 127463], [127464], [98]]
	got = [127462, 127463, 127464, 98]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97], [127462, 127463], [127464], [98]]
	got = [97, 127462, 127463, 127464, 98]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97], [127462, 127463, 8205], [127464], [98]]
	got = [97, 127462, 127463, 8205, 127464, 98]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97], [127462, 8205], [127463, 127464], [98]]
	got = [97, 127462, 8205, 127463, 127464, 98]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97], [127462, 127463], [127464, 127465], [98]]
	got = [97, 127462, 127463, 127464, 127465, 98]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[128118, 127999], [128118]]
	got = [128118, 127999, 128118]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97, 127999], [128118]]
	got = [97, 127999, 128118]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[97, 127999], [128118, 8205, 128721]]
	got = [97, 127999, 128118, 8205, 128721]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[128118, 127999, 776, 8205, 128118, 127999]]
	got = [128118, 127999, 776, 8205, 128118, 127999]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
...
expect {
	exp = [[128721, 8205, 128721]]
	got = [128721, 8205, 128721]
		.map(CodePoint.internal_from_u32_unchecked)
		->CodePoint.to_str()?
		->Grapheme.split()?
		->GraphemeTest.to_code_point_list()
