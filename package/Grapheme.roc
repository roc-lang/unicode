...
Grapheme :: GBP.{
    ...
    split : Str -> Try(List(Str), Utf8ParseErr)
    split = |str| {
        # TODO DISCUSS
        ...
        code_points = CodePoint.parse_utf8(str.to_utf8())?
        break_points = code_points.map(InternalGBP.from_cp)

        Ok(to_list_str(split_help(Next, code_points, break_points, [BR(GB1)])))
    }
}
...
to_list_str = |tokens| {
    res = tokens.fold(
        ...
        |state, curr| {
            match curr {
                NB(_) => state
                BR(_) => if state.acc.is_empty() {
                    state
                } else { acc: [], cps: state.cps.append(state.acc) }
                CP(cp) => { acc: state.acc.append(cp), cps: state.cps }
            }
        },
    )
    ...
    res.cps.map(
        |cp_list| {
            ...
            match CodePoint.to_str(cp_list) {
                Ok(str) => str
                Err(_) => {
                    crash "unreachable got invalid utf8 when converting CodePoints to Str"
                }
            }
        },
    )
...
split_help = |state, code_points, break_points, acc| {
    next_c_ps = code_points.drop_first(1)
    next_b_ps = break_points.drop_first(1)

    match (state, code_points, break_points) {
        ...
        (LastWithPrev(prev), [cp], [bp]) if bp == ZWJ => {
            if InternalEmoji.is_pictographic(prev.to_u32()) {
        ...
        (EmojiSeqNext(prev), [cp, ..], [_, ..]) => {
            if InternalEmoji.is_pictographic(cp.to_u32()) {
        ...
        _ => {
            crash "This is definitely a bug in the roc-lang/unicode package, caused by an unhandled edge case in grapheme text segmentation."

            # TODO: Uncomment once https://github.com/roc-lang/roc/issues/9856 is resolved.
            ...
            # \\${Str.inspect((state, code_points.map(CodePoint.to_u32), break_points))}
        }
    }
}
...
test_help = |u32_list| {
    code_points = u32_list->join().map(CodePoint.internal_from_u32_unchecked)
    break_points = code_points.map(InternalGBP.from_cp)
...
expect {
    a = test_help([[888], [888]])
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB5), CP(CodePoint.internal_from_u32_unchecked(13)), NB(GB3), CP(CodePoint.internal_from_u32_unchecked(10)), BR(GB2)]
    a == b
}
...
expect {
    a = test_help([[1], [13]])
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(1)), BR(GB4), CP(CodePoint.internal_from_u32_unchecked(13)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(13)), BR(GB4), CP(CodePoint.internal_from_u32_unchecked(776)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB2)]
    a == b
}
...
expect {
    a = test_help([[32], [13]])
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(32)), BR(GB5), CP(CodePoint.internal_from_u32_unchecked(13)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(10)), BR(GB4), CP(CodePoint.internal_from_u32_unchecked(776)), BR(GB5), CP(CodePoint.internal_from_u32_unchecked(13)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4352)), NB(GB6), CP(CodePoint.internal_from_u32_unchecked(4352)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4352)), NB(GB6), CP(CodePoint.internal_from_u32_unchecked(4448)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4352)), NB(GB6), CP(CodePoint.internal_from_u32_unchecked(44509)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4352)), NB(GB6), CP(CodePoint.internal_from_u32_unchecked(45739)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4352)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4448)), NB(GB7), CP(CodePoint.internal_from_u32_unchecked(4448)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(45236)), NB(GB7), CP(CodePoint.internal_from_u32_unchecked(55243)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(45236)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(888)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(44619)), NB(GB8), CP(CodePoint.internal_from_u32_unchecked(55243)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4607)), NB(GB8), CP(CodePoint.internal_from_u32_unchecked(55243)), BR(GB2)]
    a == b
}
...
expect {
    a = test_help([[4607, 13]])
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(4607)), BR(GB5), CP(CodePoint.internal_from_u32_unchecked(13)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(888)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(8205)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(63)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(2381)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(2340)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(44033)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(8205)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(888)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(776)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(8205)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(9985)), NB(GB9), CP(CodePoint.internal_from_u32_unchecked(8205)), NB(GB11), CP(CodePoint.internal_from_u32_unchecked(9985)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [
        BR(GB1),
        CP(CodePoint.internal_from_u32_unchecked(128118)), # BABY (ExtPict) >> has GBP of (Other)
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(127999)), # EMOJI MODIFIER FITZPATRICK TYPE-6 (Extend) >> has GBP of (Extend)
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(776)), # COMBINING DIAERESIS (Extend_ExtCccZwj) >> has GBP of (Extend)
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(8205)), # ZERO WIDTH JOINER (ZWJ_ExtCccZwj) >> has GBP of (ZWJ)
        NB(GB11),
        CP(CodePoint.internal_from_u32_unchecked(128118)), # BABY (ExtPict) >> has GBP of (Other)
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(127999)), # EMOJI MODIFIER FITZPATRICK TYPE-6 (Extend) >> has GBP of (Extend)
...
expect {
    ...
    b = [
        BR(GB1),
        CP(CodePoint.internal_from_u32_unchecked(97)),
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(127999)),
        BR(GB999),
        CP(CodePoint.internal_from_u32_unchecked(128118)),
        NB(GB9),
        CP(CodePoint.internal_from_u32_unchecked(8205)),
        NB(GB11),
        CP(CodePoint.internal_from_u32_unchecked(128721)),
        BR(GB2),
    ]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(127462)), NB(GB12), CP(CodePoint.internal_from_u32_unchecked(127462)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(127462)), NB(GB12), CP(CodePoint.internal_from_u32_unchecked(127462)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(127462)), BR(GB2)]
    a == b
}
...
expect {
    ...
    b = [BR(GB1), CP(CodePoint.internal_from_u32_unchecked(127462)), NB(GB12), CP(CodePoint.internal_from_u32_unchecked(127463)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(127464)), BR(GB999), CP(CodePoint.internal_from_u32_unchecked(98)), BR(GB2)]
    a == b
}

expect Grapheme.split("🥷🏼") == Ok(["🥷🏼"])
expect Grapheme.split("🇦🇺🦘🪃") == Ok(["🇦🇺", "🦘", "🪃"])
